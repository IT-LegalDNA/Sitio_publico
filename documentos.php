    ...
    <div class="container dcs" >
      ...
      <div>
        <div class="mdFqs">
          ...
          <div class="mdQst">
            <div class="lmts"> 
              <h6 class="fndmnt">Fundamento legal: Artículos 2606 al 2615 del Código Civil Federal</h6>
              <ul>
                <li class="fq">
                  <a class="lnk">
                    <h6>¿Cómo me puede servir?</h6>
                    <p>Se usa para formalizar la prestación del servicio…</p>
