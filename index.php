  ...
  <body>
    ...
    <div class="container" >
      ...
      <div class="mdDts bdDwn">
        <div class="lmts"> 
          <div class="thumb">
            <video class="versus" width="465" controls>
          ...
          <div class="nfrmtv">
            ...
            <p>El uso de la tecnolog&iacute;a aplicada a la prestaci&oacute;n de servicios legales que pueden ser estandarizables con la finalidad de aumentar la rentabilidad, reduciendo tiempos y costos.</p>
      ...
      <div class="mdSlg">
        <div class="lmts"> 
          <h2 class="tit-aspectos"><a href="<?php echo URLS_FOR_MENUS.'aspectos.php'; ?>">Aspectos legales</a></h2>
        </div>
      </div>
